...
[![Latest Stable Version](https://poser.pugx.org/pointdnd/yii2-comments/v/stable)](https://packagist.org/packages/pointdnd/yii2-comments) 
[![Total Downloads](https://poser.pugx.org/pointdnd/yii2-comments/downloads)](https://packagist.org/packages/pointdnd/yii2-comments) 
[![License](https://poser.pugx.org/pointdnd/yii2-comments/license)](https://packagist.org/packages/pointdnd/yii2-comments)
[![Build Status](https://travis-ci.org/pointdnd/yii2-comments.svg?branch=master)](https://travis-ci.org/pointdnd/yii2-comments)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/pointdnd/yii2-comments/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/pointdnd/yii2-comments/?branch=master)
...
```
php composer.phar require --prefer-dist pointdnd/yii2-comments "*"
```

or add

```
"pointdnd/yii2-comments": "*"
```
...
```php
php yii migrate --migrationPath=@vendor/pointdnd/yii2-comments/migrations
```
...
```
>**NOTE:** Module id must be `comment` and not otherwise. This is because it is referred [somewhere](https://github.com/pointdnd/yii2-comments/blob/master/traits/ModuleTrait.php#L20) in the code with such name. A PR to fix it to use configured module id is welcome.
...
<?php echo \pointdnd\comments\widgets\Comment::widget([
    'model' => $model,
]); ?>
```
...
'modules' => [
    'comment' => [
        ...
        'controllerMap' => [
            'default' => [
                'class' => 'pointdnd\comments\controllers\DefaultController',
...
All text and messages introduced in this extension are translatable under category 'pointdnd.comments'.
